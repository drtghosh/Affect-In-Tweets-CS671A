# -*- coding: utf-8 -*-
"""
Created on Sat Apr 14 15:24:11 2018
...
f = open('Word2vec_Bagging_results.txt', 'w')
sys.stdout = f
...
#Bagging Reg model
regMethod = "Ensemble: Bagging"
regModel = BaggingRegressor(base_estimator=None, n_estimators=10, max_samples=1.0, max_features=1.0, bootstrap=True, bootstrap_features=False, oob_score=False, warm_start=False, n_jobs=1, random_state=None, verbose=0)
