# -*- coding: utf-8 -*-
"""
Created on Sat Apr 14 14:53:19 2018
...
f = open('Word2vec_ShallowNN_results.txt', 'w')
sys.stdout = f
...
#NN Keras Reg model
regMethod = "Shallow Neural Net"
def NN_model():
    #create model
    model = Sequential()
    model.add(Dense(10, input_dim=400, init='uniform', activation='relu'))
