# -*- coding: utf-8 -*-
"""
Created on Sat Apr 14 14:42:21 2018
...
f = open('Word2vec_LinearR_results.txt', 'w')
sys.stdout = f
...
#Linear Reg model
regMethod = "Linear Regression"
regModel = LinearRegression(fit_intercept=True, normalize=False, copy_X=True, n_jobs=1)
